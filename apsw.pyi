...
class Cursor:
    ...
    def close(self, force: bool = False) -> None: ...
    description: tuple
    def execute(self, statements: str, bindings: Optional[Union[Tuple, List, Dict]] = None) -> Iterator: ...
    def executemany(self, statements: str, sequenceofbindings: Optional[Sequence[Union[Tuple, List, Dict]]]) -> Iterator: ...
