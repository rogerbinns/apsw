...
class Connection:
    ...
    def createaggregatefunction(self, name: str, factory: Optional[Callable], numargs: int = -1) -> None: ...
    ...
    def setprogresshandler(self, callable: Optional[Callable], nsteps: int = 20) -> None: ...
