...
class AsyncChangeset:
    ...
    @staticmethod
    async def apply(changeset: ChangesetInput, db: Connection | AsyncConnection, *, filter: Callable[[str], bool | Awaitable[bool]] | None = None, filter_change: Callable[[TableChange], bool | Awaitable[bool]] | None = None, conflict: Callable[[int,TableChange], int | Awaitable[int]] | None = None, flags: int = 0, rebase: bool = False) -> bytes | None:
        """Applies a changeset to a database.
    ...
    @staticmethod
    async def concat_stream(A: ( SessionStreamInput | AsyncSessionStreamInput ), B: ( SessionStreamInput | AsyncSessionStreamInput ), output: ( SessionStreamOutput | AsyncSessionStreamOutput )) -> None:
        """Streaming concatenate two changesets
    ...
    @staticmethod
    async def invert_stream(changeset: ( SessionStreamInput | AsyncSessionStreamInput ), output: ( SessionStreamOutput | AsyncSessionStreamOutput )) -> None:
        """Streaming reverses the effect of the supplied changeset.
