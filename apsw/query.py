...
class _SQLSourceLoader(importlib.abc.SourceLoader):
    ...
    def get_source(self, fullname: str):
        return _make_py_from_text(self.path.read_text(encoding="utf8"), f"Import {self.path.name}")

    def get_data(self, path: str):
        return self.get_source(path).encode("utf8")


def _make_py_from_text(text: str, source: str) -> str:
...
# This code was generated by apsw.query from
# {source}
