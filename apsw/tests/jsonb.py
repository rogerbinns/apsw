...
class JSONB(unittest.TestCase):
    ...
    def testNumbers(self):
        ...
        for item in (0, 0.0, float(123), float(-123), math.pi, -math.pi, math.e, -math.e, math.tau, -math.tau, math.inf, -math.inf):
            self.check_item(item)
        ...
        # allows leading and trailing dots, hex
        for float5, expected in (
            ...
            self.check_item(encoded5, expected)
