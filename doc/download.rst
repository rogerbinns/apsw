...
* `apsw-3.41.2.2.zip
  <https://github.com/rogerbinns/apsw/releases/download/3.41.2.2/apsw-3.41.2.2.zip>`__
  (Source, includes this HTML Help)

* `apsw-3.41.2.2-sigs.zip 
  <https://github.com/rogerbinns/apsw/releases/download/3.41.2.2/apsw-3.41.2.2-sigs.zip>`__
...
Verify
  ...
  ``.asc`` filename.  This example verifies the source::
      ...
      $ gpg --verify apsw-3.41.2.2.zip.asc
