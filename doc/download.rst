...
* `apsw-3.7.0-r1.zip
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.zip>`_
  (Source, includes this HTML Help)

* `apsw-3.7.0-r1.chm
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.chm>`_
...
* `apsw-3.7.0-r1.win32-py2.3.exe
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.win32-py2.3.exe>`_
  (Windows Python 2.3)

* `apsw-3.7.0-r1.win32-py2.4.exe
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.win32-py2.4.exe>`_
  (Windows Python 2.4)

* `apsw-3.7.0-r1.win32-py2.5.exe
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.win32-py2.5.exe>`_
  (Windows Python 2.5)

* `apsw-3.7.0-r1.win32-py2.6.exe
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.win32-py2.6.exe>`_
  (Windows Python 2.6)

* `apsw-3.7.0-r1.win32-py2.7.exe
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.win32-py2.7.exe>`_
  (Windows Python 2.7)

* `apsw-3.7.0-r1.win32-py3.1.exe
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1.win32-py3.1.exe>`_
  (Windows Python 3.1)

* `apsw-3.7.0-r1-sigs.zip 
  <http://apsw.googlecode.com/files/apsw-3.7.0-r1-sigs.zip>`_
...
Verify
  ...
  ``.asc`` filename.  This example verifies the source::
      ...
      $ gpg --verify apsw-3.7.0-r1.zip.asc
