...
* `apsw-3.14.1-r1.zip
  <https://github.com/rogerbinns/apsw/releases/download/3.14.1-r1/apsw-3.14.1-r1.zip>`__
  (Source, includes this HTML Help)

* Windows Python 2.3 `32bit
  <https://github.com/rogerbinns/apsw/releases/download/3.14.1-r1/apsw-3.14.1-r1.win32-py2.3.exe>`__

* Windows Python 2.4 `32bit
  <https://github.com/rogerbinns/apsw/releases/download/3.14.1-r1/apsw-3.14.1-r1.win32-py2.4.exe>`__

* Windows Python 2.5 `32bit
  <https://github.com/rogerbinns/apsw/releases/download/3.14.1-r1/apsw-3.14.1-r1.win32-py2.5.exe>`__
...
Verify
  ...
  ``.asc`` filename.  This example verifies the source::
      ...
      $ gpg --verify apsw-3.14.1-r1.zip.asc
...
Use this (all one command)::
    ...
    pip install --user https://github.com/rogerbinns/apsw/releases/download/3.14.1-r1/apsw-3.14.1-r1.zip \
