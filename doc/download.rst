...
* `apsw-3.39.2.1.zip
  <https://github.com/rogerbinns/apsw/releases/download/3.39.2.1/apsw-3.39.2.1.zip>`__
  (Source, includes this HTML Help)

* `apsw-3.39.2.1-sigs.zip 
  <https://github.com/rogerbinns/apsw/releases/download/3.39.2.1/apsw-3.39.2.1-sigs.zip>`__
...
Verify
  ...
  ``.asc`` filename.  This example verifies the source::
      ...
      $ gpg --verify apsw-3.39.2.1.zip.asc
