...
* `apsw-3.7.6.2-r1.zip
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.zip>`_
  (Source, includes this HTML Help)

* `apsw-3.7.6.2-r1.chm
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.chm>`_
...
* Windows Python 2.3 `32bit
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win32-py2.3.exe>`__

* Windows Python 2.4 `32bit
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win32-py2.4.exe>`__

* Windows Python 2.5 `32bit
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win32-py2.5.exe>`__

* Windows Python 2.6 `32bit
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win32-py2.6.exe>`__
  `64bit 
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win-amd64-py2.6.exe>`__

* Windows Python 2.7 `32bit
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win32-py2.7.exe>`__
  `64bit 
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win-amd64-py2.7.exe>`__

* Windows Python 3.1 `32bit
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win32-py3.1.exe>`__
  `64bit 
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win-amd64-py3.1.exe>`__

* Windows Python 3.2 `32bit
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win32-py3.2.exe>`__
  `64bit 
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1.win-amd64-py3.2.exe>`__

* `apsw-3.7.6.2-r1-sigs.zip 
  <http://apsw.googlecode.com/files/apsw-3.7.6.2-r1-sigs.zip>`_
...
Verify
  ...
  ``.asc`` filename.  This example verifies the source::
      ...
      $ gpg --verify apsw-3.7.6.2-r1.zip.asc
