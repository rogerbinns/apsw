...
/* This file was generated by parsing how configure altered the Makefile
   ...
   \n""")
    ...
    def verifyurl(self, url, data):
        ...
        for line in read_whole_file(sums, "rtU").split("\n"):
            line=line.strip()
...
def create_c_file(src, dest):
    ...
    percents=1
    size=0
    for line in read_whole_file(src, "rtU").split("\n"):
...
version=read_whole_file(os.path.join("src", "apswversion.h"), "rtU").split()[2].strip('"')
