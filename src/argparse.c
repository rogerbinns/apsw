...
#define ARG_TYPE_CHECK(varname, type, cast)                                                                            \
    ...
    {                                                                                                                  \
        ...
        case 1:                                                                                                        \
            ...
            break;                                                                                                     \
        case 0:                                                                                                        \
            PyErr_Format(PyExc_TypeError, "Expected %s not %s", Py_TypeName(type),                                     \
                         Py_TypeName(useargs[argp_optindex]));                                                         \
            /* fallthru */                                                                                             \
        case -1:                                                                                                       \
            goto param_error;                                                                                          \
...
#define ARG_List_int_int(varname)                                                                                      \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            {                                                                                                          \
                if (!PyErr_Occurred())                                                                                 \
                    PyErr_Format(PyExc_TypeError, "Function argument list[int,int] expected int for item %d not %s",   \
                                 i, Py_TypeName(list_item));                                                           \
                goto param_error;                                                                                      \
            }                                                                                                          \
        }                                                                                                              \
        varname = useargs[argp_optindex];                                                                              \
