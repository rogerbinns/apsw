...
set -ex
$CC $CFLAGS $MOREFLAGS $PROFILE -UNDEBUG -DSQLITE_ENABLE_API_ARMOR -DAPSW_USE_SQLITE_AMALGAMATION  -DAPSW_FAULT_INJECT -DSQLITE_ENABLE_FTS5  -DSQLITE_ENABLE_SESSION -I$INCLUDEDIR -Isrc -Isqlite3 -I. -c src/apsw.c
