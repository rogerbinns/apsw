insert into toc values
    ...
    ('SQLITE_CHANGEGROUP_CONFIG_PATCHSET', 'constant', 0, 'Options for sqlite3changegroup_config()', 'session/c_changegroup_config_patchset.html'),
    ...
    ('sqlite3changeset_apply_v3', 'function', 0, 'Apply A Changeset To A Database', 'session/sqlite3changeset_apply.html'),
    ...
    ('sqlite3changeset_apply_v3_strm', 'function', 0, 'Streaming Versions of API functions.', 'session/sqlite3changegroup_add_strm.html'),
