...
set -x
rm -f apsw.o apsw.so
gcc -pthread -fno-strict-aliasing  -g $opt -D_FORTIFY_SOURCE=2 -fPIC -W -Wall $cflags -DEXPERIMENTAL -DSQLITE_THREADSAFE=1 -DAPSW_USE_SQLITE_AMALGAMATION=\"sqlite3.c\" -I$INCLUDEDIR -c apsw.c
